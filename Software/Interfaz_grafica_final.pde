...
Serial puerto;
int bloque1, bloque2, bloque3, bloque4, bloque5, bloque6, D1, D2, D3, D4, data, acele, temp, analog1, analog2, analog3, prev, level, x, valor, nivel, hora, minut;
...
void draw(){
    ...
    if(puerto.read() == 243){            // Verifico que se haya leido el header
      ...
      hora = hour();
      minut = minute();
      if (hora==15 && minut>=40 && minut<=50) image(sprinkler, 720, 765);    // Hora en la que se riega el cultivo (De 3:30pm a 3:40pm)
